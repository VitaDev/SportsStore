        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product { Name = "Lifejacket", Description = "Protective and fashionaЫe", Category = "Watersports", Price = 48.95m },
                    ...
                    new Product { Name = "Thinking Сар", Description = "Improve brain efficiency Ьу 75i", Category = "Chess", Price = 16 },
